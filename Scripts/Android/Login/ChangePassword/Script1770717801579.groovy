...
Mobile.tap(findTestObject('Object Repository/Login/android.webkit.WebView'), 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.Button - Continue to Login'), 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Login/android.widget.EditText (1)'), '${GlobalVariable.loginUsername}')

Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText (2)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Login/android.widget.EditText (3)'), '${GlobalVariable.loginPassword}')
