...
Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText'), '123456')
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Tee Times'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Available Reserve Now'), 0)
